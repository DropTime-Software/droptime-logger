...
- **Device reports — the single most valuable contribution.** Own a machine we don't support? Ten minutes of your time gets your rig on the roadmap. Open a [device report](https://github.com/RyanLuttrell/droptime-logger/issues/new?template=device-report.yml) — the in-app hardware sniffer has a "copy diagnostic" button that produces a block you can paste straight into the template.
