...
<p align="center">
  <a href="https://github.com/RyanLuttrell/droptime-logger/actions/workflows/ci.yml"><img src="https://github.com/RyanLuttrell/droptime-logger/actions/workflows/ci.yml/badge.svg" alt="CI"></a>
  <a href="https://github.com/RyanLuttrell/droptime-logger/releases/latest"><img src="https://img.shields.io/github/v/release/RyanLuttrell/droptime-logger?display_name=tag&sort=semver" alt="Latest release"></a>
...
**Own a machine we don't support yet?** Ten minutes of your time gets your rig on the roadmap. Open a [device report](https://github.com/RyanLuttrell/droptime-logger/issues/new?template=device-report.yml) — the in-app sniffer has a **Copy diagnostic** button that pastes your port, frame dump, and hardware details straight into it.

## Install

Download the latest build for your platform from the [Releases page](https://github.com/RyanLuttrell/droptime-logger/releases).
...
Questions, roasts, and feature ideas belong in [GitHub Discussions](https://github.com/RyanLuttrell/droptime-logger/discussions). Bugs and device reports go through the [issue templates](https://github.com/RyanLuttrell/droptime-logger/issues/new/choose).
