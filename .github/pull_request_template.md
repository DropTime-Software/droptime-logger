...
- [ ] I've read the [Contributing guide](https://github.com/RyanLuttrell/droptime-logger/blob/main/CONTRIBUTING.md).

---

By opening this PR you'll be asked to sign the [CLA](https://github.com/RyanLuttrell/droptime-logger/blob/main/CLA.md) — a one-time comment on your first contribution. It lets Droptime include your work in both the open-source Logger and Droptime's commercial products, while you keep your own copyright. The CLA bot posts the details automatically.
